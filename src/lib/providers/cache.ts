// Tiny in-process TTL cache. Used for the manifest and provider module
// sources; a module-level Map is fine on serverless because each instance
// only lives for the duration of one batch of requests anyway.
