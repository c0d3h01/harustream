...
import { getCinemetaMeta, addCinemetaContext, getCinemetaSeason, readCinemetaContext, enrichCinemetaEpisodes } from './cinemeta';
...
export async function getMeta({
  ...
  try {
    ...
    console.error('Vega getMeta error:', err);
