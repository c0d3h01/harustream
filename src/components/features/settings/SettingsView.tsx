...
export const SettingsView = memo(function SettingsView({
  ...
  return (
    <section className="py-6 sm:py-10">
      ...
      <div className="grid max-w-5xl gap-6 lg:grid-cols-[minmax(0,1.15fr)_minmax(18rem,.85fr)] lg:items-start">
        <div>
        ...
        <aside className="rounded-3xl border border-primary/20 bg-primary/5 p-6 lg:sticky lg:top-24">
          ...
          <p className="mt-3 text-sm leading-6 text-muted-foreground">
            Home browsing and search now aggregate every live provider. Your preferred source only
