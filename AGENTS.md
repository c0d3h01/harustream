...
- Repo skill set lives in `.agents/skills/` (gitignored): `vercel-react-best-practices` for React/Next perf rules, plus `rust-best-practices` — follow the vercel skill when writing React components.